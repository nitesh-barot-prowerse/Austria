...
public class ClientPageSteps {
    ...
    //Add client scenario Using UI and json file
    ...
    public void user_enters_all_details_of_client_on_edit_client_window_from_from(String string) throws Exception {
        clientPage.editClientData(string);
    }
    ...
    //Search client based on client code
    ...
    //Filter Client based on active dropdown status option
